...
from bev_multimae.multimae.model_utils import Block

class Bev_MultiMAE(nn.Module):
    def __init__(self,
    ...
    def forward(self, 
        ...
        batch_size = next(iter(input_task_tokens.values())).shape[0]
        ...
        global_tokens = repeat(self.global_tokens, '() n d -> b n d', b=batch_size)
