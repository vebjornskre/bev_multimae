...
class BEVFineData(Dataset):
    def __init__(
        ...
        self.meta = torch.load(os.path.join(pretrain_path, "meta.pt"), weights_only=False, map_location='cpu')
    ...
    def __getitem__(self, idx):
        ...
        data   = torch.load(pretrain_file, weights_only=False, map_location='cpu')
